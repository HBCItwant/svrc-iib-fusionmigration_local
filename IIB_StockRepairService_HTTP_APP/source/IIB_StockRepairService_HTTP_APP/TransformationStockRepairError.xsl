      ...
      <msg_in_out:StockRepairResponse>
         <ns1:StockRepairResponseTypeDataList>
            <ns1:StockRepairResponseTypeData>
               ...
               <ns1:code>
                   <xsl:text disable-output-escaping="no">StockRepair-0001</xsl:text>
               </ns1:code>
               <ns1:message>
                   <xsl:text disable-output-escaping="no">An unexpected error occurred  while executing retrieveStockRepairByPO operation.</xsl:text>
               </ns1:message>
            </ns1:StockRepairResponseTypeData>
         </ns1:StockRepairResponseTypeDataList>
      </msg_in_out:StockRepairResponse>
